...
It saves you from complicated prop drilling so you don't have to keep going down and down with props.
...
Reducers manage changes in state while maintaining the immutability we want in our components.
...
I like context api as it's easier to setup and wrap my head around.
...
- [x] You _must_ use either context or Redux as your state management system - Context API was used
